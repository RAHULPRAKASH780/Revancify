...
```
curl -sL "https://raw.githubusercontent.com/RahulPrakash780/Revancify/main/install.sh" | bash
```
...
<details>
  ...
  ```
pkg update -y -o Dpkg::Options::="--force-confnew" && pkg install git -y && git clone --depth=1 https://github.com/RahulPrakash780/Revancify.git && ./Revancify/revancify
```
</details>
